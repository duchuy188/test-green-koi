...
function translatePathToString(absolutePath) {
  ...
  var newValue = absolutePath.map(function (params, i) {
    ...
    switch (command) {
      ...
      case 'A':
        return "A ".concat(params[1], " ").concat(params[2], " ").concat(params[3], " ").concat(params[4], " ").concat(params[5], " ").concat(params[6] + endOffsetXTemp, " ").concat(params[7] + endOffsetYTemp);
      case 'Z':
        return 'Z';
      default:
        return null;
